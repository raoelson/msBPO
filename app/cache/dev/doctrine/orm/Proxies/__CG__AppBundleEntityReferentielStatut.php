 ...
 */
class Statut extends \AppBundle\Entity\Referentiel\Statut implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Referentiel\\Statut' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Referentiel\\Statut' . "\0" . 'libelle', '' . "\0" . 'AppBundle\\Entity\\Referentiel\\Statut' . "\0" . 'dateCreation', '' . "\0" . 'AppBundle\\Entity\\Referentiel\\Statut' . "\0" . 'dateModification', '' . "\0" . 'AppBundle\\Entity\\Referentiel\\Statut' . "\0" . 'dateSuppression', '' . "\0" . 'AppBundle\\Entity\\Referentiel\\Statut' . "\0" . 'typeActions', '' . "\0" . 'AppBundle\\Entity\\Referentiel\\Statut' . "\0" . 'operations');
        }
