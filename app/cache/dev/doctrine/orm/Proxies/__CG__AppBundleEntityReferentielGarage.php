 ...
 */
class Garage extends \AppBundle\Entity\Referentiel\Garage implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Referentiel\\Garage' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Referentiel\\Garage' . "\0" . 'libelle', '' . "\0" . 'AppBundle\\Entity\\Referentiel\\Garage' . "\0" . 'operations');
        }
